...
import { CREATE_NEW_PRODUCT_RESET } from '../../constants/productConstant'
...
const NewProduct = () => {
    ...
    const {loading,error,success} = useSelector((store)=>store.newProduct)
    ...
    const createNewProductSubmitHandler = (e) => {
        e.preventDefault()
    ...
    <Fragment>
        ...
        <div className="dashboard">
            ...
            <div className="newProductContainer">
                ...
                onSubmit={createNewProductSubmitHandler}
                >
